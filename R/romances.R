#' Survey responses for questions about student romances
#'
#' A dataset containing responses about student romances
#' in the Online College Social Life Survey (OCSLS)
#'
#' @format A data frame with 24131 rows and 441 variables
